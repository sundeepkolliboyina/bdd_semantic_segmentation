...
#SK @test_safe
#SK def test_for_bdd_dataset(data_dir):
#SK     bdd_dataset_path = os.path.join(data_dir, 'data_road')
#SK     training_labels_count = len(glob(os.path.join(bdd_dataset_path, 'training/gt_image/*.png')))
#SK     training_images_count = len(glob(os.path.join(bdd_dataset_path, 'training/image/*.jpg')))
#SK     testing_images_count = len(glob(os.path.join(bdd_dataset_path, 'testing/image/*.jpg')))
#SK 
#SK     assert not (training_images_count == training_labels_count == testing_images_count == 0),\
#SK         'bdd dataset not found. Extract bdd dataset in {}'.format(bdd_dataset_path)
#SK     assert training_images_count == 69998, 'Expected 69998 training images, found {} images.'.format(training_images_count)
#SK     assert training_labels_count == 69998, 'Expected 69998 training labels, found {} labels.'.format(training_labels_count)
#SK     assert testing_images_count == 20000, 'Expected 20000 testing images, found {} images.'.format(testing_images_count)
